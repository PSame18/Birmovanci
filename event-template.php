...
<head>
    ...
    <PHP>
        <link rel="stylesheet" type="text/css" href="css/style-event-template.css">
    </PHP>
    <PHP>
...
<body id="events-body">
    ...
    <main class="container-fluid body-main">
        <h2 class="title-pages">Birmovanecké stretko</h2>
        <h5 class='card-date'>25.11.2019</h5>
        <div class="row">
            <div class="text-article">
                <img class="img-fluid float-left image-article" src="pictures/mikulaske-balicky.png">
                Prvý októbrový piatok bolo na večernej svätej omši v kostole sv. Cyrila a Metoda o niečo rušnejšie. Konalo sa totiž prvé stretnutie budúcich birmovancov. Na spoločnú prípravu sa opäť spojili farnosti Poprad-Juh a Poprad mesto. Kaplán Michal Janiga povzbudil v kázni mladých prirovnaniu nášho života k šarkanovi. Je "fuknčný", ak je podopretý krížom. Po svätej omši sa približne 200 deviatakov rozdelilo do dvadsiatich skupiniek, v ktorých ich privítali animátori a zvyšok stretnutia strávili rozhovormi a hrami pod kostolom. Tešíme sa na ďalšie stretnutie 25. októbra už aj s pripravovaným hosťom.
            </div>
        </div>

        <div class="gallery-div">
            <h3 class="title-pages">Birmovanecké stretko</h3>
        </div>
